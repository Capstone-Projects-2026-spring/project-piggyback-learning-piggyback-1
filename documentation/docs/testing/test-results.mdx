...
<a href={useBaseUrl('/coverage/index.html')} target="_blank">Click me for Full Screen</a>

<iframe src={useBaseUrl('/coverage/index.html')} width="100%" height="600px" style={{border: '1px solid #e0e0e0', borderRadius: '8px'}}></iframe>
