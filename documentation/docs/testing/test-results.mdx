...
Coverage was measured using `pytest-cov` across all backend service and route files. Overall coverage: **34%** (core services average 70%+ - lower scores reflect external API services that require live YouTube/OpenAI access to test).
