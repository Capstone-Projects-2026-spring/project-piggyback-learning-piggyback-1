...
<a href={useBaseUrl('/coverage/index.html')} target="_blank" style={{display:'inline-block',marginTop:'8px',padding:'10px 20px',background:'linear-gradient(160deg,#b8e4f7 0%,#d6eefc 40%,#f5c6d8 100%)',color:'#6a1b9a',borderRadius:'12px',fontWeight:'700',textDecoration:'none',boxShadow:'0 4px 14px rgba(100,180,220,0.3)'}}>
  📊 Click me for Full Screen
</a>

<iframe src={useBaseUrl('/coverage/index.html')} width="100%" height="500px" style={{border:'1px solid #e0e0e0',borderRadius:'8px',marginTop:'12px'}}></iframe>
